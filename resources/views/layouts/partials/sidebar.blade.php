<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="{{ action('SubjectController@index') }}"><i class="fa fa-bookmark fa-fw"></i>Subjects Managerment</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-building fa-fw"></i>Classes Managerment</a>
            </li>
            <li>
